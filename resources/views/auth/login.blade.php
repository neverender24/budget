...
#particles-js{
    ...
    <body>
        ...
        <div class="container">
            <div id="login-box">
                <div class="logo">
                    <img src="{{ asset('public/img/logo.png')}}" class="img img-responsive img-rounded center-block"/>
                    <h1 class="logo-caption"><span class="tweak">L</span>ogin</h1>
                </div><!-- /.logo -->
                <div class="controls">
                    <form class="form-horizontal" role="form" method="POST" action="{{ url('/auth/login') }}">
                        {{ csrf_field() }}
                        <input type="text" name="email" value="{{ old('email') }}" placeholder="Username" class="form-control" />
